                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('id_role') is-invalid @enderror" 
                                            ...
                                            @foreach(App\Models\User::getRoles() as $id => $name)
                                                <option value="{{ $id }}" {{ old('id_role') == $id ? 'selected' : '' }}>
                                                    {{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="toggle-switch">
                                            ...
                                            <span class="status-text ml-2 text-success" id="statusText" style="margin-left: 10px;">
                                                Kích hoạt ngay
                                            </span>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#status').change(function() {
            ...
            if ($(this).is(':checked')) {
                statusText.text('Kích hoạt ngay').removeClass('text-danger').addClass('text-success');
            } else {
                statusText.text('Không kích hoạt').removeClass('text-success').addClass('text-danger');
            }
        });
    });
</script>
